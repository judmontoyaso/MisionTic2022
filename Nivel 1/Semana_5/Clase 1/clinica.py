#implementar un sistema de turnos en una clinica
#crear una clase "clinica" que tenga como atributos un nombre
# y una lista de pacientes
#crear una clase paciente que tenga los atributos anombre, cedula, turno
#la clase clinica tiene un metodo para ingresar un nuevo paciente
#la clase clinica tiene un metodo para atender un nuevo paciente
#la clinica solo puede agregar 10 pacientes
#verificar que halla espacio para un nuevo paciente
#si ya hay 10 pacientes debe sacar un mensaje de error
