...
public class BicicletaMontania extends Bicicleta {
    ...
    public BicicletaMontania(String marca, String color, double velocidadInicial) {
    ...
    public BicicletaMontania(String marca, String color, double velocidadInicial, String pedales) {
